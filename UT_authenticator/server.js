...
function fn_startExpressServer ()
{
    ...
    // CORS request
  //  c_app.use(cors({
  //      origin: 'https://localhost:3000', // WebClient URL
  //      methods: ['GET', 'POST'],
...
{
    console.log ("==============================================");
    console.log (global.Colors.Bright + "LiveOps Authentication Server Version " +  JSON.stringify(v_pjson.version) + global.Colors.Reset);
    console.log ("----------------------------------");
...
function fn_displayInfo ()
{
    ...
    console.log ("WS ip: "  + global.Colors.BSuccess +  global.m_serverconfig.m_configuration.s2s_ws_listening_ip  + global.Colors.Reset + " port: " + global.Colors.BSuccess + global.m_serverconfig.m_configuration.s2s_ws_listening_port + global.Colors.Reset);
    ...
    if ((m_serverconfig.m_configuration.account_storage_type!=null) && (typeof(m_serverconfig.m_configuration.account_storage_type) == 'string'))
    {
        ...
        console.log (" Liscence type:  " + global.Colors.FgYellow + m_serverconfig.m_configuration.account_storage_type.toLowerCase() + global.Colors.Reset);
    }
    else
    {
        console.log (global.Colors.BError + "FATAL ERROR:" + global.Colors.FgYellow + " Liscence type: " +  global.Colors.Reset + " is not specified in config file. ");
        process.exit(0);
    }
