...
function fn_onOpen_Handler() {
    console.log(`${global.Colors.BSuccess}[OK] Connection established with LiveOps AuthServer${global.Colors.Reset}`);
...
function fn_onClose_Handler() {
    console.log(`${global.Colors.Error}ATTENTION!! Connection closed with LiveOps AuthServer${global.Colors.Reset}`);
...
function fn_onError_Handler(err) {
    console.error(`${global.Colors.Error}ATTENTION!! Connection error with LiveOps AuthServer: ${err}${global.Colors.Reset}`);
}
...
function fn_startServer() {
    ...
    console.log(`${global.Colors.BSuccess}[OK] Comm Server Manager Client connecting to ${c_url} to reach LiveOps Auth${global.Colors.Reset}`);
