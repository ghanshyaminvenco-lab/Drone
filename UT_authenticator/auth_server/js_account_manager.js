        ...
        email_server = email.server.connect(
            {
                ...
                user: global.m_serverconfig.m_configuration.smtp_user, // "info@email.com",
...
function fn_getAccountNameByAccessCode(p_accessCode, fn_callback) {
    ...
    console.log(global.Colors.BError + "FATAL ERROR:" + global.Colors.FgYellow + " Liscence type or users or connection" + global.Colors.Reset + " are not specified in config file. ");
}
